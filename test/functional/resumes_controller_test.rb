...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { date_of_birth: @resume.date_of_birth, email_id: @resume.email_id, name: @resume.name, phone_number: @resume.phone_number, summary: @resume.summary }
    end
  ...
  test "should update resume" do
    put :update, id: @resume, resume: { date_of_birth: @resume.date_of_birth, email_id: @resume.email_id, name: @resume.name, phone_number: @resume.phone_number, summary: @resume.summary }
    assert_redirected_to resume_path(assigns(:resume))
  end
